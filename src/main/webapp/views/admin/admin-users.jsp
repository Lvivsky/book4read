                ...
                <div class="col-md-12">
                    <div class="table-responsive">
                        <table id="mytable" class="table table-bordred table-striped table-sm">
                            ...
                            <tr>
                                <td style="font-size:12px;font-family: Times">Mohsin</td>
                                <td style="font-size:12px;font-family: Times">Irshad</td>
                                <td style="font-size:12px;font-family: Times">isometric.mohsin@gmail.com</td>
                                <td></td>
                                <td></td>
                                <%--                                        <td>--%>
